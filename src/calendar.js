...
angular.module('ui.calendar', [])
  ...
  .controller('uiCalendarCtrl', ['$scope', '$locale',
    function ($scope, $locale) {
      ...
      var events = $scope.eventSources.events;
      ...
      // @return {Array} all events from all events
    ...
    function (uiCalendarConfig) {
      ...
      return {
        ...
        link: function (scope, elm, attrs, controller) {
          ...
          var calendar;
          var eventSourcesWatcher = controller.changeWatcher(events, controller.sourceFingerprint);
